...
async function ejecutar() {
  ...
  try {
    ...
    pyodide.globals.set("cam3d_third_person", (obj, offset) => {cam3d_third_person_fn(obj, offset)})
    pyodide.globals.set("displaceTo3d", (obj1, obj2, smoothness) => displaceTo_fn(obj1, obj2, smoothness))
    ...
    pyodide.globals.set("set3dLightIntensity", (light, intensityy) => objectList[light].intensity = intensityy)
    pyodide.globals.set("set3dLightColor", (light, colour) => objectList[light].color = colour)
